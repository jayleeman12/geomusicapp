...
import { BackHandler, StyleSheet, Text, TextBase, View } from 'react-native';
...
const MusicList: React.FC<{}> = () => {
    return (
        <View style={{ flex: 1 }}>
            {/* <View style={styles.viewSwapButtonContainer}>
                <Icon name='map' size={30} color={COLORS.dark} />
            </View> */}
            <View style={{marginTop: '5%', height: '100%'}}>
                {playingTracks.map((playingTrack: Track, index: number) =>
                    <View key={index} style={{ height: '13%', marginTop: '5%', marginLeft: '5%' }}>
